...
module.exports.recent = (req, res) => {
    ...
    var paginated_files = _.drop(_.take(files, req.query.limit), req.query.offset).map(file => (process.env.LOCAL === "true" ? "http://localhost:5000/uploaded/" : "https://api.homesecurity.jakestringer.dev/uploaded/") + file);
